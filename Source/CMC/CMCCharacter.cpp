...
void ACMCCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &ACMCCharacter::StopJumping);

		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACMCCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACMCCharacter::Look);

	}

}

void ACMCCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACMCCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
